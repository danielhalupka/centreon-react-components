...
class SortableComponent extends Component {
  ...
  render() {
    ...
    const SortableItem = SortableElement(
      ({ value, onDelete, editModifier, isEditing, closeEditingForm }) => (
        <ListItem {...rest} className={classes.listItem}>
          ...
          <ListItemSecondaryAction className={classes.actionButtons}>
            <IconButton
              className={`${classes.moveBtn} ${classes.paddingSmall}`}
            >
              <FlipToFrontIcon className={classes.iconSmall} />
            </IconButton>
            {isEditing ? (
              <IconButton
                className={`${classes.indexLower} ${classes.paddingSmall}`}
              >
                <DoneIcon />
              </IconButton>
            ) : (
            ...
            {isEditing ? (
              <IconButton
                className={`${classes.editBtn} ${classes.paddingSmall}`}
            ...
            <IconButton
              className={`${classes.closeBtn} ${classes.paddingSmall}`}
              aria-label="Delete"
              onClick={onDelete}
            />
