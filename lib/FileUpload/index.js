  ...
  function FileUpload() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          FileUpload.__proto__ || Object.getPrototypeOf(FileUpload)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement("span", {
                className: "icon-close icon-close-middle",
                onClick: onClose
              })
            ),
            files.length > 0
