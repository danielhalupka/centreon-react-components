  ...
  function DynamicComponentPosition() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          DynamicComponentPosition.__proto__ ||
          Object.getPrototypeOf(DynamicComponentPosition)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      ...
      (_this.componentWillReceiveProps = function(nextProps) {
        ...
        if (componentName != _this.props.componentName) {
          document.removeEventListener(
            "component" + _this.props.componentName + "Loaded",
            _this.setComponentLoaded
          );
