...
var ExtensionsHolder = (function(_React$Component) {
  ...
  function ExtensionsHolder() {
    ...
    return _possibleConstructorReturn(
      this,
      (
        ExtensionsHolder.__proto__ || Object.getPrototypeOf(ExtensionsHolder)
  ...
  _createClass(ExtensionsHolder, [
    {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          Centreon.Wrapper,
          null,
          _react2.default.createElement(Centreon.HorizontalLineContent, {
            hrTitle: title
          }),
              ...
              entities.map(function(entity) {
                return _react2.default.createElement(
                  "div",
                  {
                    ...
                    className:
                      "container__col-md-3 container__col-sm-6 container__col-xs-12"
                  },
                  _react2.default.createElement(
                    Centreon.CardItem,
                    _extends(
                      {
                        itemBorderColor: entity.version.installed
                    ...
                    entity.version.installed
                      ? _react2.default.createElement(Centreon.IconInfo, {
                          iconName: "state"
                        })
                      : null,
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement(Centreon.Subtitle, {
                      ...
                      Centreon.Button,
                      {
                        ...
                        style:
                          installing[entity.id] || updating[entity.id]
                            ...
                            : {},
                        buttonType: entity.version.installed
                          ? entity.version.outdated
                            ? "regular"
                            : "bordered"
                          : "regular",
                        color: entity.version.installed
                          ? entity.version.outdated
                            ? "orange"
                            : "blue"
                          : "green",
                    ...
                    entity.version.installed
                      ? _react2.default.createElement(Centreon.ButtonAction, {
