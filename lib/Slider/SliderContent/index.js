...
var _ContentSliderRightArrow2 = _interopRequireDefault(
  _ContentSliderRightArrow
);

var _ContentSliderIndicators = require("./ContentSliderIndicators");

var _ContentSliderIndicators2 = _interopRequireDefault(
  _ContentSliderIndicators
);
...
var SliderContent = (function(_Component) {
  ...
  function SliderContent(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (SliderContent.__proto__ || Object.getPrototypeOf(SliderContent)).call(
        this,
        props
      )
    );
    ...
    _this.renderSlides = function() {
      ...
      var slides = images.map(function(image, index) {
        ...
        return _react2.default.createElement(_ContentSliderItem2.default, {
          key: index,
          image: image,
          isActive: isActive
        });
    ...
    _this.handleDotClick = function(e) {
      ...
      _this.setState({
        currentIndex: dotIndex,
        translateValue:
          translateValue + (currentIndex - dotIndex) * _this.slideWidth()
      });
    };
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_ContentSliderLeftArrow2.default, {
                goToPrevSlide: this.goToPrevSlide
              }),
              _react2.default.createElement(_ContentSliderRightArrow2.default, {
